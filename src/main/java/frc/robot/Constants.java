...
public final class Constants {
  ...
  public static final class SwerveConstants {
    ...
    public static final int[] kAbsEncoderChannel = {0, 3, 1, 2};
    public static final double[] kOffsetAngle = {0, 0, 0, 0}; //TODO find
    ...
    public static final double KP_CLIMB = 0;//TODO: find
  ...
  public static final class ArmConstants {
    public enum Setpoints {
      ...
      CONE_LOW_LEVEL_POINT(-60, -52.5),
      CONE_MID_LEVEL_POINT(0, -37.5),
      CONE_HIGH_LEVEL_POINT(-100, 16),
...
//        kG.put(0,0);
    ...
    public static final double kMaxLinearVelocity = 1;
    public static final double kMaxLinearAcceleration = 1;

    public static final double ABS_ENCODER_OFFSET_ANGLE_DEG = 0;
    public static final int PHYSICAL_FRONT_MAX_ARM_ANGLE_DEG = 300;
    public static final int PHYSICAL_BACK_MAX_ARM_ANGLE_DEG = 254;
